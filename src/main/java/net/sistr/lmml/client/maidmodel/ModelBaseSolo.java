...
public class ModelBaseSolo<T extends LivingEntity> extends ModelBaseNihil<T> implements IModelBaseMMM {
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        ModelRenderer.packedOverlay = OverlayTexture.NO_OVERLAY;
        ModelRenderer.red = 1;
        ModelRenderer.blue = 1;
        ModelRenderer.green = 1;
        ModelRenderer.alpha = 1;
    ...
    public ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation("minecraft", "textures/entity/littlemaid/mmm_aug/aug_0c.png");
    }
