...
public class ModelSelectScreen extends Screen {
    ...
    public static void renderColor(int minX, int minY, int maxX, int maxY, int rgba) {
        fill(minX, minY, maxX, maxY, rgba);
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        this.minecraft.getTextureManager().bindTexture(MODEL_SELECT_GUI_TEXTURE);
        this.blit(relX, relY + HEIGHT + 8, 0, 240, 16, 16);
    ...
    public static class ModelGUI implements GUI {
        ...
        public void render(int mouseX, int mouseY, float partialTicks) {
            ...
            if (selectLine != -1 && 0 <= selectLine - scrollLine && selectLine - scrollLine < 3) {
                ...
                renderColor(minX, minY, maxX, maxY, 0x60FFFFFF);
            }
            if (selectColor != null) {
                ...
                renderColor(minX, minY, maxX, maxY, selectColor.getColorCode() | 0x40000000);
            }
            for (int i = 0; i < 3; i++) {
                ...
                renderAllColorModel(baseX, baseY + appendY, 15,
        ...
        public void renderAllColorModel(int posX, int posY, int scale, float mouseX, float mouseY,
            ...
            fontRenderer.drawString(holder.getTextureName(),
    ...
    public static class ArmorGUI implements GUI {
        ...
        public void render(int mouseX, int mouseY, float partialTicks) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                ModelMultiBase model = modelManager.getModel(holder.getModelName(), IHasMultiModel.Layer.SKIN)
                        .orElseThrow(IllegalStateException::new);
                renderAllArmorModel(baseX, baseY + appendY, 15,
                        screenInfo.getWidth() / 2F - mouseX,
                        screenInfo.getHeight() / 2F - mouseY, model, holder);
            }
            animating = (screenInfo.getWidth() + width) / 2F - 45 <= mouseX
        ...
        public void renderAllArmorModel(int posX, int posY, int scale, float mouseX, float mouseY,
                                        ModelMultiBase model, TextureHolder holder) {
            int index = 0;
            LMModelManager modelManager = LMModelManager.INSTANCE;
        ...
        public void render(int mouseX, int mouseY, float partialTicks) {
            {
                ...
                renderColor(minX, minY, maxX, maxY, 0xFF000000);
            }
            {
                int minX = screenInfo.getWidth() / 2 + x;
                int maxX = minX + width;
                ...
                int maxY = minY + width;
                renderColor(minX, minY, maxX, maxY, 0xFFFFFFFF);
            }
        }
