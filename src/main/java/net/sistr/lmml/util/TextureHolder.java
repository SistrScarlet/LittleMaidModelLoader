...
public class TextureHolder {
    ...
    public Optional<ResourceLocation> getTexture(TextureColor color, boolean isContract, boolean isLight) {
    ...
    public Optional<ResourceLocation> getArmorTexture(@Nonnull IHasMultiModel.Layer layer, @Nonnull String armorName, float damagePercent, boolean isLight) {
        int index;
        switch (layer) {
            case INNER:
